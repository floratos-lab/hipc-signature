...
<script>
  ...
  gtag('config', 'UA-169441884-1');
    ...
    <link rel="stylesheet" href="css/hipc.css" type="text/css" />
</head>
...
<body>
             ...
             <div class="row">
                 <div class="col-9">
                     <table id="gene-details-grid" class="table table-bordered table-striped">
                         ...
                         <tr><th>Immune Regulation</th><td><a href="https://immuneregulation.mssm.edu/metadata-all.html?s={{displayName}}" target="_blank">{{displayName}}</a></td></tr>
                         <tr>
                             <th>References</th>
                             <td>
                                 <ul class="refs">
    ...
    <script type="module" src="js/hipc.js"></script>
