                    ...
                    <div class="span12">
                        <div class="featurette" id="overview-text">
                            ...
                            <p class="lead firstlead">
                                ...
                                A central goal of the HIPC is the identification of molecular “signatures” that correlate with the outcomes of vaccinations, 
                                adjuvants or natural infections in humans. These signatures result from the computational analysis of large-scale experimental data 
                                from high-throughput systems biology approaches coupled with detailed clinical phenotyping in well-characterized human cohorts. 
                                The data generated by these studies is captured in the NIH/NIAID <a href="http://www.immport.org/">ImmPort</a> repository, 
                                as well as the HIPC <a href="https://www.immunespace.org/">ImmuneSpace</a> database and analysis engine. 
                                However, there is currently no formal framework for making the derived results of these analyses, namely HIPC-generated immune signatures, 
                                available to the wider scientific community. Thus, most of these signatures are only available as part of publications, 
                                creating a bottleneck for sharing and comparative analysis.
                            </p><p class="lead firstlead">
                                To address this challenge, the consortium developed the open-access “HIPC Dashboard,” 
                                a web interface that compiles consistently annotated immune signatures generated by HICP activities as well as curated from the literature. 
